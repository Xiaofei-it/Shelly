...
Suppose that you want to print the names of all the files in a folder. Using the Shelly library, you
...
Using the Shelly library, you may write the following to fulfil the above requirement:
